...
| All 3 hooks | Real, executable Python; **95/95 hook + graph tests passing** |
...
| Tests | **95/95 passing**: hook unit tests + graph end-to-end tests + crisis-keyword regression suite covering live-discovered phrasings |
